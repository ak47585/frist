...
<body>
<div class="box">
    <div class="box-title">修改学生信息</div>
    <div style="color: red;">${error}</div>
    <form class="form-horizontal" action="/customer/update" method="post" onsubmit="return true;">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label" for="customer_phone">学生电话</label>
            <div class="col-sm-8">
                <input value="${customer.phone}" type="tel" class="form-control" name="phone" id="customer_phone" placeholder="学生电话">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input class="form-control btn-info" type="submit" value="修改信息">
            </div>
            <div class="col-sm-3"></div>
        </div>
    </form>
